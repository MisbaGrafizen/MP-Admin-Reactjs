          ...
          <div className="w-[100%] flex flex-col gap-[30px]">
            <div className="flex gap-[10px] flex-wrap" ref={inputRef}>
              ...
              {buttons.map((text, index) => (
                <div
                  key={index}
                  className={`border-[1px] border-[#000] font-[600] text-[18px]  w-[120px] h-[40px] flex justify-center items-center rounded-[10px] cursor-pointer ${
                ...
                <>
                  ...
                  <div className="border-[1px] border-dashed border-[#feaa00] rounded-[10px] h-[100%] w-[180px]">
                    <div className="flex justify-center w-fullitems-center ">
                      <img
                        className=" h-[140px] w-[100%]  rounded-tl-[8px] rounded-tr-[8px]  "
            ...
            {(onClose) => (
              <>
                <div className="relative ">
                  <div className=" px-[20px] py-[20px]   relative">
                    <div className=" w-[100%] flex gap-[29px] flex-col">
                      <div className="w-[100%] flex gap-[16px]">
                        <div
                          className="border-[1px] border-dashed max-h-[170px]  border-[#feaa00] rounded-[8px] flex justify-center items-center w-[167px] cursor cursor-pointer"
                          onClick={onOpen}
                        >
                          <label
                            htmlFor="imageUpload"
                        ...
                        <div className=" flex flex-col w-[100%] gap-[20px]">
                          ...
                          <div className="flex">
                            <textarea
                              name=""
                              className="font-[500] w-[79%] p-[10px] border-[#000] outline-none border-[1.9px] rounded-[8px] h-[120px] text-[15px]"
                              id=""
                            >
                              Self note :{" "}
                            </textarea>
                  ...
                  <div
                    className=" w-full  text-white cursor-pointer items-center font-[600] flex justify-center mt-[16px]   h-[40px] bg-[#00984b] text-[20px]"
