        ...
        <>
            <div className="w-[99%] h-[100%]  relative overflow-hidden  px-[40px] py-[48px] mx-auto   my-auto ">
                <div className="  mx-auto flex gap-[30px] h-[90vh] flex-col relative   rounded-[19px] border-[1px] border-[#FEAA00]">
                    ...
                    <div className='border-t-[1.5px] font-[600] cursor-pointer  border-l-[1.5px] border-r-[1.5px] text-[#FEAA00] h-[45px] top-[50px]  active:bg-[#feaa00] active:text-[#fff] md150:top-[5.8%] right-[10%] w-[160px] flex items-center justify-center   rounded-tl-[10px]  absolute border-[#FEAA00] rounded-tr-[10px] ro' onClick={onOpen}>
                        <p>
                            Create a new user
                        </p>
                    </div>
                                    ...
                                    <div className="w-full h-full mx-auto rounded-[10px] border border-black overflow-x-hidden relative">
                                        <div className="box-border w-full">
                                            <div className="sticky top-0 flex bg-[#FEAA00] border-black w-full">
                                                ...
                                                <div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[15%] max-w-[88%]">
                                                    <p className="text-[18px] font-[600] font-Outfit text-[#fff]">Pravruti</p>
                                                </div><div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[15%] max-w-[88%]">
                                                    <p className="text-[18px] font-[600] font-Outfit text-[#fff]">Kshetra</p>
                                                </div>
                                                <div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[16%] max-w-[88%]">
                                                    <p className="text-[18px] font-[600] font-Outfit text-[#fff] ">Designation</p>
                                                </div>
                                                <div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[16%] max-w-[88%]">
                                                    <p className="text-[18px] font-[600] font-Outfit text-[#fff]">Phone no.</p>
                                                </div>
                                                <div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[8%] max-w-[8%]">
                                                    <p className="text-[18px] font-[600] font-Outfit text-[#fff]">Age</p>
                                                </div>
                                                <div className="flex justify-center text-center py-2 border-b border-black px-3 min-w-[9%] max-w-[10%]">
                                                    <p className="text-[18px] font-[600] font-Outfit text-[#fff]">Actions</p>
                                                </div>
                                            ...
                                            {Array.isArray(users) && users.length > 0 ? (
                                                users.map((item, index) => (
                                                    <div key={index} className='flex justify-between'>
                                                        ...
                                                        <div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[15%] max-w-[88%]">
                                                            <p className="text-[18px] font-[300] font-Outfit "> {item?.name}</p>
                                                        </div>
                                                        <div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[15%] max-w-[88%]">
                                                            <p className="text-[18px] font-[300] font-Outfit ">{item?.pravruti?.name}</p>
                                                        </div><div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[15%] max-w-[88%]">
                                                            <p className="text-[18px] font-[300] font-Outfit">{item?.kshetra?.name}</p>
                                                        </div>
                                                        <div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[16%] max-w-[88%]">
                                                            <p className="text-[18px] font-[300] font-Outfit ">{item?.designation?.name}</p>
                                                        </div>
                                                        <div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[16%] max-w-[88%]">
                                                            <p className="text-[18px] font-[300] font-Outfit ">{item?.phoneNumber}</p>
                                                        </div>
                                                        <div className="flex justify-start text-center py-[10px] border-r border-b border-black px-3 min-w-[8%] max-w-[8%]">
                                                        ...
                                                        <div className="flex justify-center items-center gap-[15px] text-center py-2 border-b  border-black min-w-[9%] max-w-[10%]">
                                                            <img className='w-[20px]' src='../../public/img/Foodsection/edit.png' />
                                        ...
                                        <div className='relative '>
                                            <div className='relative'>
                                                <div className='flex justify-center  p-[30px]'>
                                                    <img className='w-[90px]' src='../../public/img/AdminSpalsh/user 3.png' />
                                                </div>
                                                <div className='flex gap-[30px]  px-[30px]'>
                                                    ...
                                                    <div className='flex flex-col  gap-[10px]'>
                                                        ...
                                                        <div className='flex items-center  gap-[40px]'>
                                                            <p className='text-[18px] font-[600]'>Pravruti:</p>
                                                        </div>
                                                        <div className='flex items-center  gap-[40px]'>
                                                            <p className='text-[18px] font-[600]'>Kshetra:</p>
                                                        </div>
                                                        <div className='flex items-center  gap-[40px]'>
                                                            <p className='text-[18px] font-[600]'>Designation:</p>
                                                        </div>
                                                        <div className='flex items-center  gap-[40px]'>
                                                            <p className='text-[18px] font-[600]'>Phone no:</p>
                                                        </div>
                                                        {/* <div className='flex items-center  gap-[40px]'>
                                                            <p className='text-[18px] font-[600]'>Age:</p>
                                                        </div> */}
                                                        <div className='flex items-center  gap-[40px]'>
                                                            <p className='text-[18px] font-[600]'>Password</p>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div className='flex items-center gap-[40px]'>
                                                            ...
                                                            >
                                                                ...
                                                                {pravruties?.map((pravruti) => (
                                                                    <option key={pravruti?._id} value={pravruti?._id}>
                                                                        {pravruti?.name}
                                                                    </option>
                                                                ))}
                                                            </select>
                                                ...
                                                <div className=" bg-[#00984B] cursor-pointer font-[600] text-[18px] relative bottom-[-42px] w-[full] flex justify-center py-[10px] text-[white]" onClickCapture={onClose}
