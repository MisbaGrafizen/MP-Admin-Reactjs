                  ...
                  <div className="w-[100%] px-[13px] flex justify-between">
                    <div className="flex border-[1.4px] gap-[10px] items-center px-[10px] h-[35px] w-[250px] border-[#00984B] rounded-[6px]">
                      ...
                      <input
                        type="text"
                        placeholder="Search"
                        className="w-[100%] placeholder-shown:text-[#b0abab] outline-none rounded-[6px]"
                      />
                    </div>
                    ...
                    <div className="flex gap-[10px]">
                      ...
                      {[...Array(totalPages)].map((_, index) => (
                        <button
                          ...
                          className={`w-[30px] h-[30px] rounded-[5px] flex justify-center items-center text-[16px] ${
                            currentPage === index + 1
                              ? "bg-[#00984B] text-[#fff]"
