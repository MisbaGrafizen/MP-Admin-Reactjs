...
//                       <div
//                         key={index}
//                         className="flex justify-center items-center flex-col rounded-[10px] border-[1.5px] border-[#FEAA00] border-dashed"
//                       >
//                         <div
//                           className="h-[200px] w-[200px] flex justify-center items-center cursor-pointer"
//                           onClick={onOpen}
...
//                     <input
//                       className="h-[70px] justify-center w-full text-[20px] flex items-center border-[1.5px] font-[600] px-[20px] text-[#fff] rounded-[10px] bg-[#6A6A6A] border-[#fffaf5] border-dashed "
//                       type="text"
//                       placeholder="Name"
//                       value={name}
//                       onChange={(e) => setName(e.target.value)}
...
//                   </div>
//                   <div
//                     className="h-[70px] justify-center bg-[#00984B] w-full text-[20px] cursor-pointer flex items-center border-[1.5px] font-[600] px-[10px] text-[#fff] rounded-[10px] border-[#fffaf5] border-dashed "
//                     onClick={handleSubmit}
//                   >
//                     <p>Submit & Save Premvati</p>
//                   </div>
