  ...
  return (
    <>
          ...
          <div className="md11:py-[69px] md150:py-[90px] flex md11:w-[98%] md150:w-[97%] md11:gap-[15px]  md150:gap-[20px]">
            ...
            <div className="  py-[20px] px-[20px]  md150:h-[70vh] md11:h-[73vh]   h-[67vh] bg-white  w-[100%] rounded-[19px] relative   border-[1px]  my-justify-center items-center  border-[#000000]">
              <div className="flex flex-wrap w-full gap-[20px]">
                <div className="flex justify-between items-center md150:h-[220px] md11:h-[180px]  md150:w-[200px] md11:w-[150px]  flex-col rounded-[10px] border-[1.5px] border-[#F28C28] border-dashed">
                  <div
                  ...
                  <div className="h-[50px] justify-center flex items-center border-t-[1.5px] font-[600] text-[#fff] rounded-[10px] border-[#fffaf5] border-dashed w-[100%] bg-[#F28C28]"></div>
                </div>
                {premvatis &&
                  premvatis?.map((item) => (
                    <>
                      ...
                      >
                        ...
                        <div className="h-[180px] w-[200px] flex justify-center items-center cursor-pointer">
                          <img
                            className="h-[127px] w-[140px] rounded-tl-[8px]  rounded-tr-[8px]"
                            src={item?.image}
                            alt=""
                          />
                        </div>
      ...
      <Modal
        ...
        className="absolute top-[180px]  rounded-[10px]  bottom-0 h-[360px]  w-[280px] flex items-center "
        backdrop="blur"
      >
            ...
            <>
              <div className="flex justify-between h-[100%] w-[100%] items-center flex-col  border-dashed">
                <div className=" w-[100%] h-[100%]">
                  ...
                  <label
                    htmlFor="imageUpload"
                    className=" mx-auto flex w-[100%] justify-center  h-[100%] !items-center cursor-pointer"
                  >
                    {previewImage ? (
                      <img
                        src={previewImage}
                      ...
                      <i className="text-[60px] flex items-center text-[#FEAA00] fa-solid fa-plus"></i>
                    )}
                    <input
                      type="file"
                      id="imageUpload"
